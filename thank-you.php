...
$cdate=date('Y-m-d');
$sql ="SELECT id FROM tblattendance WHERE empId=:empid and date(checkInTime)=:cdate";
...
$query = $dbh -> prepare("INSERT INTO tblattendance(empId,checkInTime,checkInIP,remark) 
