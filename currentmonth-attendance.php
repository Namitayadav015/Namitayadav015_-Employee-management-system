...
echo "NA";
                  ...
                  <td>  
      <?php  $chkintime=$result->checkInTime;
                 $newcintdate=date("Y-m-d", strtotime($chkintime));    
  if(($couttime=='') and ($newcintdate==date('Y-m-d'))):?>
<form method="post">
<input type="submit" name="checkout" value="Checkout" class="btn btn-danger">
</form>
<?php endif; ?>
                   </td>
                  </tr>
